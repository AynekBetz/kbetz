...
function pickOdds(pick) {
  ...
  if (recommended.includes(away)) return pick?.awayOdds;
  if (recommended.includes(home)) return pick?.homeOdds;

  return pick?.awayOdds || pick?.homeOdds || "—";
}
      ...
      <section className="record-hero">
        <div>
          ...
          <p className="record-subtitle">
            Every logged pick is tracked with posted time, odds source,
